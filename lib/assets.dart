class Assets {
  ...
  static const dashboardIcon1 = "${imageDirectory}dashboard_icon1.svg";
  static const dashboardIcon2 = "${imageDirectory}dashboard_icon2.svg";
  static const dashboardIcon3 = "${imageDirectory}dashboard_icon3.svg";
  static const arrowIcon = "${imageDirectory}arrow_icon.svg";
  static const profileIcon = "${imageDirectory}profile_icon.svg";
  static const changePasswordIcon = "${imageDirectory}change_password_icon.svg";
  static const myQRCodeIcon = "${imageDirectory}my_qr_code_icon.svg";
  static const historyIcon = "${imageDirectory}history_icon.svg";
  static const logoutIcon = "${imageDirectory}logout_icon.svg";
  static const homeIcon = "${imageDirectory}home_icon.svg";
  static const bellIcon = "${imageDirectory}bell_icon.svg";
